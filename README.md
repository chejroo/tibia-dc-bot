...
Every day at **08:00 Europe/Warsaw** (CEST/CET handled automatically), `good_morning.py` posts `/book character:Druid Fireblade spot:Book World - Chapter IIl date:24.09.2026 start:12:00 end:14:00` (as plain text) to a channel **from your own account**.
